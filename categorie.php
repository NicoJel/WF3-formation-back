...
require_once __DIR__ . '/include/init.php';$query = 'SELECT nom FROM categorie WHERE id = ' . (int)$_GET['id'];
$stmt = $pdo->query($query);
$titre = $stmt->fetchColumn();$query = 'SELECT * FROM produit WHERE categorie_id = ' . (int)$_GET['id'];
$stmt = $pdo->query($query);
$produits = $stmt->fetchAll();require __DIR__ . '/layout/top.php';
?>
<h1><?= $titre; ?></h1><div class="card-deck">
   <?php
